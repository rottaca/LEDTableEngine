...
void FractalApp::draw(Image &frame){
  draw_Mandelbrot(frame,
                  m_frac.center.x - m_frac.dim.x/m_currZoom, m_frac.center.x + m_frac.dim.x/m_currZoom,
                  m_frac.center.y - m_frac.dim.y/m_currZoom, m_frac.center.y + m_frac.dim.y/m_currZoom,
...
void FractalApp::draw_Mandelbrot(Image &frame,                                   //where to draw the image
